...
function App() {
  ...
  const API_KEY = "5e4bccceac38841ef6fbcfe350feda68"
  ...
  return (
      <div className="App">
        <header className="center-max-size header">
          <span className={"brand"}><a href="https://www.themoviedb.org/?language=en-US"><h3>The Movie Database</h3></a></span>
        ...
        {movies.length ?
            ...
            : <h2><span>Sorry, no movies were found. Please try again.</span></h2>}
      </div>
  );
}
